...
alert('Welcome To This Webpage Dear Customer' + fullName);


//                   EX # 02

var favoriteComputer = prompt('enter your favourite Computer model : ');
document.write('My favourite Computer model is : ' + favoriteComputer + '<br>');
document.write('Length of String is : '  + (favoriteComputer.length) +  '<br>' + '<br>');
...
cityi = cityh.replace("Dublin","Islam");
document.write('After Replacement : '+cityi + '<br>' + '<br>');


//                  EX # 08

var message = 'Mariyam and Sheryar are my best friends. They both play best cricket and football.';
...
var A = ['Bananas','apple','Mango','Orange','Peach'];
var Cherryies = prompt('Enter you wanna choose : ');
Cherryies = Cherryies.toLowerCase();
for(i=0;i<A.length;i++){
    if(A[i] === Cherryies
        document.write(Cherryies + ' is available at index ' + A.indexOf(cafu) + ' in our fruit shop.' + '<br>' + '<br>');
    }
else{
        document.write('we are sorry ' + Cherryies + 'is not available in our bakery!');
        break
    }
}
...
if ( Day1 === 'Saturday' || Day1 === 'Sunday'){
    document.write('It\'s Sunday!'+ '<br>' + '<br>');
...
function greet()
    {
        ...
        var lastName$ = prompt('Enter our last name : ');
        var fullName$ = firstName$ + ' ' + lastName$;
        return alert('Welcome To This Webpage' + fullName$);
    }
greet();
